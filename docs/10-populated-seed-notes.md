# Populated Seed Notes

These live seed files are a best-effort starting point based on the current Renaissance roster, the current chief assignments, and the current final-project framework.
...
## Items the instructor may still want to refine
- final team-member department assignments
- the actual pop-up date
- exact revenue and donation targets
- whether additional product lines should be seeded later
- whether Co-CEOs can edit due dates alongside the instructor
