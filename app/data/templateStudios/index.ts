...
import { marketingCustomerInsights } from './marketing-customer-insights'
...
export const templateStudios: Record<string, TemplateStudio> = {
  ...
  'ch-03-company-structure-and-continuity': missionVisionValues,
  'ch-04-business-model-canvas': businessModelCanvas,
  'ch-05-house-phoenix-brand-book': housePhoenixBrandStory,
  'ch-06-supporting-brand-sheets': marketingCustomerInsights,
